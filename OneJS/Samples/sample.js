...
var tween_1 = require("tweenjs/tween");
...
var App = function () {
    ...
    (0, hooks_1.useEffect)(function () {
        ...
        setPos1(p1);
        setPos2(p2);
        var tween = new tween_1.Tween(p2).to({ x: p2.x, y: p2.y - height / 6 * 2 }, 5000)
            .easing(tween_1.Easing.Quadratic.InOut).onUpdate(function () {
